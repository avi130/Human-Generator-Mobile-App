...
import 'package:sss/drawingarea.dart';
...
class _HomeState extends State<Home> {
  ...
  void saveToImage(List<DrawingArea> ppoints) async {
  ...
  void fetchResponse(var base64Image) async {
    ...
    try {
      var response = await http.post(
          Uri.parse("http://192.168.1.34:5000/predict"),
          body: body,
          headers: headers);
